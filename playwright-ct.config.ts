    ...
    ctViteConfig: {
      ...
      resolve: {
        alias: [
          ...
          // Mock for Cloudflare Turnstile hook
          { find: 'ui/shared/cloudflareTurnstile/useCloudflareTurnstile', replacement: './playwright/mocks/ui/shared/cloudflareTurnstile/useCloudflareTurnstile.js' },
