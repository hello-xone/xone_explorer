...
import type { EasApiResourceName, EasApiResourcePayload } from './services/eas';
import { EAS_API_RESOURCES } from './services/eas';
...
R extends EasApiResourceName ? EasApiResourcePayload<R> :
